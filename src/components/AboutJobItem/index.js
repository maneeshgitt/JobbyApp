...
class AboutJobItem extends Component {
    ...
    getJobData = async props => {
        ...
        if(responseJobData.ok === true){
            ...
            const updateSimilarJobDetails = fetchedJobData.similar_jobs.map(eachItem => ({
                companyLogoUrl : eachItem.company_logo_url,
                id : eachItem.id,
                jobDescription : eachItem.job_description,
                employmentType : eachItem.employment_type,
    ...
    renderJobDetailsSuccessView = () => {
        ...
        if(jobDataDetails.length >= 1){
            const {
                companyLogoUrl, employmentType, companyWebsiteUrl, jobDescription, lifeAtCompany, location, packagePerAnnum, rating, skills, title
            } = jobDataDetails[0]
            ...
            return (
                <>
                    <div className="job-item-container">
                        <div className="first-part-container">
                            ...
                            <div  className="location-package-container">
                                <div className="location-job-type-container">
                                    ...
                                    <div className="employment-typee-icon-employment-type-container">
                        ...
                        <div className="comapny-life-img-container">
    ...
    renderJobFailureView = () => (
        <div className="job-details-failure-view">
            ...
            <div className="btn-container-failure">
                <button className="failure-job-details-btn" type = "button" onClick = {this.onRetryJobDetailsAgain}>retry</button>
            </div>
        </div>
    )
